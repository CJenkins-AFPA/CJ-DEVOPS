...
Intégrations v1 (fonctionnelles dès le début) :

Git (GitHub/GitLab) : opérations API pour lire repos/branches/MR, rattacher commits aux jobs.
​
...
Vue serveur : collecte de métriques basiques (CPU/RAM/disk) côté host/VM.
​
