...
- `owner_id: int` (User, typiquement rôle Projets ou Admin)
- `created_at`, `updated_at`
...
L’API calendrier exposera ces events au format FullCalendar (title, start, end, extendedProps, etc.). [web:282][web:285]
...
Ce log servira plus tard de base à des analyses IA (patterns de changement, anomalies, etc.). [web:340][web:345]
